  ...
  return (
    <Popover className="relative">
      <Popover.Button className="p-[3px] block group outline-none">
        <div className="inline-flex gap-5 p-3 items-center rounded-full group-hover:bg-[#eff3f41a] transition-colors">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
        <button className="px-4 h-14 w-full outline-none inline-flex gap-5 items-center hover:bg-[#eff3f41a] transition-colors">
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={26.25} height={26.25} className="block">
              <path
                fill="#fff"
        ...
        <button className="font-bold  px-4 h-14 w-full outline-none inline-flex gap-5 items-center hover:bg-[#eff3f41a] transition-colors">
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={26.25} height={26.25} className="block">
              <path
                fill="#fff"
        ...
        <hr className="w-[80%]  border-[#2F3336]"/>
        ...
        <Disclosure>
          ...
          <Disclosure.Panel className="text-gray-500">
            ...
            <Link
                to="/"
                className="flex items-center  h-11 gap-3  text-[15px] font-medium text-white">
                <svg viewBox="0 0 24 24" width={18.75} height={18.75} className="block">
                  <path
                    fill="currentColor"
